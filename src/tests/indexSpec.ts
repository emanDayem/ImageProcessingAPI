...
describe("app test", () => {
  ...
  describe("utils test", () => {
    ...
    it("test getImagePath with undefined width and height", async () => {
      ...
      const expectedOutput = "E:\\Folder\\file.jpg";
      expect(actualOutput).toBe(expectedOutput);
    });
